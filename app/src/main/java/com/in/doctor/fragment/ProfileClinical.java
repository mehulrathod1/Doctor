...
public class ProfileClinical extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_profile_clinical, container, false);
        init();
        doctorClinic(Glob.Token, Glob.user_id);
        return view;
    }
