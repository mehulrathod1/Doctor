...
public class ProfileLifestyle extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_profile_lifestyle, container, false);
        init();
        doctorLifestyle(Glob.Token, Glob.user_id);
